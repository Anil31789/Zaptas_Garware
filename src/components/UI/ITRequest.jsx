  ...
  return (
    ...
    >
      ...
      >
        ...
        <a href="https://www.bseindia.com/stock-share-price/garware-polyester-ltd/garwarpoly/500655/" target="_blank" className="celebrating-text">Today's GHFL share price</a>
        </div>
      </div>
    </div>
  );
